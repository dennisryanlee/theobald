<template>
    <div class="limit-width center pb-100 pink-links">
        ...
        <p>I love movies. Obviously, I'm a huge fan of anything tech-related... The Social Network, Hackers, The Net, Silicon Valley, Mr. Robot, etc. Just like my music tastes, I find enjoyment in just about every genre of film. I'm a big fan of acting, actors, film making, Hollywood, etc. and there's just nothing better than unwinding to a good movie or binge-watching a series sometimes.</p>
        ...
        <p>
            ...
            <a
                ...
                target="blank"
            >The Circle View</a> (formerly Satellite Hero).
        </p>
        <br />
        <p>
        ...
        <h2>Biking</h2>
        <p>I currently own a Trek Shift 3 bicycle which I use to commute to work on as often as I can.</p>
